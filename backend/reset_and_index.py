...
# Set environment variables for consistent embedding
os.environ.setdefault('OPENAI_API_KEY', 'dummy-key-for-testing')  # Replace with your actual key
os.environ.setdefault('QDRANT_URL', 'http://localhost:6333')  # This won't be used with local mode
